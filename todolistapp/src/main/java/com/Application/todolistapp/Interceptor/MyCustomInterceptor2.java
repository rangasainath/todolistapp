...
//        return HandlerInterceptor.super.preHandle(request, response, handler);
        System.out.println("This PreHandleFunction from Inteceptor2");
        return true;
    }
...
//        return HandlerInterceptor.super.postHandle(request, response, handler, modelandview);
        System.out.println("This is PostHandle from Inteceptor2");
    }

    @Override
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, @Nullable Exception ex) throws Exception {
//        return HandlerInterceptor.super.afterCompletion(request, response, handler);
        System.out.println("This is After Completion from Inteceptor2");
    }
}